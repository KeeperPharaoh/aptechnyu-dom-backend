...
class ContentController extends Controller
{
    ...
    {
        $content = ConditionContent::query()
                                   ->first();
    ...
    {
        $content = ProcedureContent::query()
                                   ->first();
